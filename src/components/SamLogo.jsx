...
export default function SamLogo({ size = 52, className = "" }) {
  ...
  return (
    ...
    >
      ...
      {/* Left sweeping petal */}
      <path
        d="M110 62 C88 78 66 105 70 135 C74 160 94 178 110 186
      ...
      <path
        d="M110 62 C132 78 154 105 150 135 C146 160 126 178 110 186
      ...
      <path
        d="M110 58 C104 80 102 105 104 130 C106 152 110 170 110 186
      ...
      <path
        d="M110 70 C106 90 105 112 107 133 C108 150 110 165 110 180
